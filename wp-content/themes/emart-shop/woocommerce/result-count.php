...
$products_per_page = get_theme_mod( 'emart_shop_posts_per_page', '12' );
 ...
 */
$link = apply_filters( 'emart_shop_num_products_link', $link );
...
<ul class="result-count">
    <li class="view-title"><?php echo esc_html__('View:','emart-shop'); ?>
	</li>
    ...
    <li><a class="view-all<?php if ( $num_prod == 'all' ) echo esc_attr('active'); ?>" href="<?php echo esc_url( add_query_arg( 'products-per-page', 'all', $link  ) ) ?>"><?php echo esc_html__('ALL:','emart-shop'); ?></a></li>
</ul>
